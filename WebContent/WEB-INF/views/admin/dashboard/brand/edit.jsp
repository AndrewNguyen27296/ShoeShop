	...
	<div class="row">
		<div class="col-md-12 col-lg-8 col-lg-offset-2">
			<div class="panel panel-default">
				<div class="panel-title">Edit brand</div>
				<div class="panel-body">
					<form:form action="admin/dashboard/edit/brand/"
						...
						<div class="form-group">
							...
							<button type="submit" class="btn btn-default pull-right kj-button">Save</button>
						</div>
					</form:form>
				</div>
			</div>
