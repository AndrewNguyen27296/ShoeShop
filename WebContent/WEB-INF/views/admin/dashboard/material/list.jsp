		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-title">
					Details
					<a href="admin/dashboard/add/material/" class="btn btn-sm btn-info pull-right">
					...
					<table id="example0" class="table display">
						<thead>
							<tr>
								<th>#</th>
								<th>Material name</th>
								<th>Material name VN</th>
								<th>*</th>
								<th>*</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="m" items="${mates}" varStatus="i">
								<tr>
									<td>${i.count}</td>
									<td>${m.material}</td>
									<td>${m.materialVN}</td>
									<td><a href="admin/dashboard/edit/material/${m.id}" class="btn btn-sm btn-primary">Edit</a></td>
									<td><a href="admin/dashboard/delete/material/${m.id}" class="btn btn-xs btn-danger"><i class="fa fa-remove"></i></a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
