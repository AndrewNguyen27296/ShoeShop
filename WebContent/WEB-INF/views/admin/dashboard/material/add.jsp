...
<div class="page-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="admin/dashboard/list/materials/">Materials</a></li>
		...
		<div class="col-md-12 col-lg-8 col-lg-offset-2">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form:form action="admin/dashboard/add/material/"
						modelAttribute="mate" method="POST">
						<div class="form-group">
							<label for="material" class="form-label">Material Name</label>
							<form:input path="material" cssClass="form-control" />
						</div>
						<div class="form-group">
							<label for="materialVN" class="form-label">Material Name VN</label>
							<form:input path="materialVN" cssClass="form-control" />
						</div>
						<div class="form-group">
							<span class="error">${error}</span><span class="success">${success}</span>
							<button type="submit"
								class="btn btn-default pull-right kj-button">Add</button>
						</div>
					</form:form>
				</div>
			</div>
